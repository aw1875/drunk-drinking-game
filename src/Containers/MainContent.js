    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.state.currentPlayer === "" || this.state.currentRole === 0? <StartGame image="./img/start.png" text="Start" data={{start:this.handleStart.bind(this)}} /> : cardsComponents[this.state.currentRole]}
